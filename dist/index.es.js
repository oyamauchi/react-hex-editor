import React, { memo, forwardRef, useMemo, useCallback, createContext, useContext, useReducer, useRef, useLayoutEffect, useEffect, useImperativeHandle } from 'react';
import joinClassNames from 'classnames';
import Keycoder from 'keycoder';
import { KEY_0, KEY_1, KEY_2, KEY_3, KEY_4, KEY_5, KEY_6, KEY_7, KEY_8, KEY_9, KEY_A, KEY_B, KEY_C, KEY_D, KEY_E, KEY_F, KEY_DOWN, KEY_LEFT, KEY_PAGE_DOWN, KEY_PAGE_UP, KEY_RIGHT, KEY_UP, KEY_DELETE, KEY_BACK_SPACE, KEY_END, KEY_HOME, KEY_TAB } from 'keycode-js';
...
var HexOffsetLabel = function (_a, ref) {
    ...
    var formattedOffset = useMemo(function () { return (formatOffset && offset != null ? formatOffset(offset) : offset); }, [offset, formatOffset]);
    return (React.createElement("div", { className: className, ref: ref, style: style }, formattedOffset));
};
HexOffsetLabel.displayName = 'HexOffsetLabel';
var HexOffsetLabel$1 = memo(forwardRef(HexOffsetLabel));

var HexEditorGutter = function (_a, ref) {
    var _b = _a.children, children = _b === void 0 ? React.createElement(React.Fragment, null, "\u00A0") : _b, className = _a.className, style = _a.style;
...
var HexEditorGutter$1 = memo(forwardRef(HexEditorGutter));
...
var HexByte = function (_a, ref) {
    ...
    return (React.createElement("div", { className: joinClassNames(className, (_b = {},
        ...
        React.createElement("span", { className: classNames.nybbleHigh }, value != null ? (value >>> 4).toString(16) : React.createElement(React.Fragment, null, "\u00A0")),
        React.createElement("span", { className: classNames.nybbleLow }, value != null ? (value & 0xf).toString(16) : React.createElement(React.Fragment, null, "\u00A0"))));
};
HexByte.displayName = 'HexByte';
var HexByteValue = memo(forwardRef(HexByte));
...
var HexByteAscii = function (_a, ref) {
    ...
    var formattedValue = useMemo(function () { return (formatValue && value != null ? formatValue(value) : value); }, [value, formatValue]);
    var handleMouseDown = useCallback(function (e) {
        if (setSelectionStart && e.button === 0 && !e.ctrlKey) {
            if (e.shiftKey) {
                e.preventDefault();
    ...
    return (React.createElement("div", { className: joinClassNames(className, (_b = {},
            ...
            _b[classNames.selectionEnd || ''] = isSelectionEnd,
            _b[classNames.selectionStart || ''] = isSelectionStart,
            _b)), "data-offset": offset, onClick: setSelectionRange && handleClick, onDoubleClick: setSelectionRange && handleDoubleClick, onMouseDown: setSelectionStart && handleMouseDown, onMouseMove: setSelectionEnd && handleMouseMove, ref: ref, style: style }, placeholder == null ? formattedValue : (React.createElement(React.Fragment, null,
        React.createElement("span", { style: { position: 'absolute' } }, formattedValue),
        placeholder))));
};
HexByteAscii.displayName = 'HexByteAscii';
var HexAsciiValue = memo(forwardRef(HexByteAscii));
...
var HexEditorRow = function (_a, ref) {
    ...
    var dataOffsets = useMemo(function () {
    ...
    return (React.createElement("div", { className: className, ref: ref, style: style },
        !showLabel ? null : (React.createElement(React.Fragment, null,
            React.createElement(HexOffsetLabel$1, { className: joinClassNames((_b = {},
            ...
            React.createElement(HexEditorGutter$1, { className: isHeader ? classNames.gutterHeader : classNames.gutter, style: styles.gutter }))),
        !(columns || data.length) ? null : (React.createElement("div", { className: classNames.byteValues, style: styles.byteValues }, dataOffsets.map(function (offset, columnIndex) {
            ...
            return (React.createElement(HexByteValue, { className: isHeader ? classNames.byteHeader : classNames.byte, classNames: classNames, columnIndex: columnIndex, isCurrentColumn: isCurrentColumn, isCurrentRow: isCurrentRow, isCursor: isCursor && !disabled, isEditing: isEditing && !disabled, isSelected: isSelected && !disabled, isSelectionCursor: isSelectionCursor && !disabled, isSelectionEnd: isSelectionEnd && !disabled, isSelectionStart: isSelectionStart && !disabled, key: offset, offset: offset, rowIndex: rowIndex, setSelectionEnd: setSelectionEnd, setSelectionRange: setSelectionRange, setSelectionStart: setSelectionStart, style: styles.byte, value: value }));
        }))),
        !showAscii ? null : (React.createElement(React.Fragment, null,
            React.createElement(HexEditorGutter$1, { className: isHeader ? classNames.gutterHeader : classNames.gutter, style: styles.gutter }),
            React.createElement("div", { className: classNames.asciiValues, style: styles.asciiValues }, dataOffsets.map(function (offset, columnIndex) {
                var isCursor = offset === cursorOffset && !isSelecting;
                var isSelected = offset >= selectionStart && offset < selectionEnd;
                var isSelectionStart = offset === selectionStart;
                var isSelectionEnd = offset === selectionEnd - 1;
                ...
                return (React.createElement(HexAsciiValue, { className: isHeader ? classNames.asciiHeader : classNames.ascii, classNames: classNames, columnIndex: columnIndex, formatValue: formatValue, isCursor: isCursor && !disabled, isEditing: isEditing && !disabled, isSelected: isSelected && !disabled, isSelectionCursor: isSelectionCursor && !disabled, isSelectionEnd: isSelectionEnd && !disabled, isSelectionStart: isSelectionStart && !disabled, key: offset, offset: offset, placeholder: asciiPlaceholder, rowIndex: rowIndex, setSelectionEnd: setSelectionEnd, setSelectionRange: setSelectionRange, setSelectionStart: setSelectionStart, style: styles.ascii, value: value }));
            }))))));
};
HexEditorRow.displayName = 'HexEditorRow';
var HexEditorRow$1 = memo(forwardRef(HexEditorRow), areRowPropsEquivalent);

var HexEditorContext = createContext({
...
var HexEditorBodyRow = function (_a) {
    ...
    var _b = useContext(HexEditorContext), asciiPlaceholder = _b.asciiPlaceholder, classNames = _b.classNames, columns = _b.columns, cursorColumn = _b.cursorColumn, cursorOffset = _b.cursorOffset, cursorRow = _b.cursorRow, data = _b.data, formatOffset = _b.formatOffset, formatValue = _b.formatValue, isEditing = _b.isEditing, nonce = _b.nonce, nybbleHigh = _b.nybbleHigh, selectionDirection = _b.selectionDirection, selectionEnd = _b.selectionEnd, selectionStart = _b.selectionStart, setSelectionEnd = _b.setSelectionEnd, setSelectionRange = _b.setSelectionRange, setSelectionStart = _b.setSelectionStart, showAscii = _b.showAscii, showRowLabels = _b.showRowLabels, styles = _b.styles;
    return (React.createElement(HexEditorRow$1, { asciiPlaceholder: asciiPlaceholder, className: classNames.row, classNames: classNames, columns: columns, cursorColumn: cursorColumn, cursorOffset: cursorOffset, cursorRow: cursorRow, data: data, formatOffset: formatOffset, formatValue: formatValue, isEditing: isEditing, nonce: nonce, nybbleHigh: nybbleHigh, offset: rowIndex * columns, rowIndex: rowIndex, selectionDirection: selectionDirection, selectionEnd: selectionEnd, selectionStart: selectionStart, setSelectionEnd: setSelectionEnd, setSelectionRange: setSelectionRange, setSelectionStart: setSelectionStart, showAscii: showAscii, showLabel: showRowLabels, style: styles.row ? __assign(__assign({}, itemStyle), styles.row) : itemStyle, styles: styles }));
};
...
var HexEditorBody = function (_a, ref) {
    ...
    var innerElementType = useMemo(function () {
        if (bodyChildren) {
...
var HexEditor = function (_a, ref) {
    ...
    var columnData = useMemo(function () { return new Array(columns).fill(0).map(function (_v, i) { return i; }); }, [columns]);
    var rowListRef = useRef(null);
    var inputRef = useRef(null);
    var stateRef = useRef(__assign({ columns: columns,
        data: data,
        readOnly: readOnly,
        rows: rows,
    ...
    var setSelectionRange = useCallback(function (start, end, direction, takeFocus) {
        var _a;
        if (takeFocus) {
            focus();
        }
    ...
    var setSelectionStart = useCallback(function (offset, editMode, _e) {
    ...
    var setSelectionEnd = useCallback(function (offset, editMode, e) {
    ...
    var setValue = useCallback(function (offset, value) {
        if (typeof onSetValue === 'function') {
            onSetValue(offset, value);
        }
    }, [onSetValue]);
    var scrollTo = useCallback(function (scrollTop) {
        if (rowListRef.current) {
            rowListRef.current.scrollTo(scrollTop);
        }
    }, []);
    var scrollToItem = useCallback(function (rowIndex, align) {
        if (rowListRef.current) {
    ...
    var handleKeyDown = useCallback(function (e) {
        ...
        var offsetAmounts = (_a = {},
            _a[KEY_DOWN] = columns,
            _a[KEY_LEFT] = 1,
            _a[KEY_PAGE_DOWN] = rows * columns,
            _a[KEY_PAGE_UP] = rows * columns,
            _a[KEY_RIGHT] = 1,
            _a[KEY_UP] = columns,
            _a);
        switch (true) {
    ...
    var handleItemsRendered = useCallback(function (props) {
        setState(props);
        if (onItemsRendered) {
    ...
    var rowCount = useMemo(function () { return Math.ceil(data.length / columns); }, [data.length, columns]);
    var formatOffset = useMemo(function () {
    ...
    var _s = useMemo(function () { return ({
    ...
    var editorStyle = useMemo(function () { return (style && inlineStyles.editor
        ? __assign(__assign({}, inlineStyles.editor), style) : (style || inlineStyles.editor || undefined)); }, [style, inlineStyles.editor]);
    var headerStyle = useMemo(function () { return (__assign(__assign({}, inlineStyles.header), { height: rowHeight, width: width })); }, [inlineStyles.header, rowHeight, width]);
    var bodyStyle = useMemo(function () { return (__assign(__assign({}, inlineStyles.body), { overflowY: 'scroll' })); }, [inlineStyles.body]);
    var hexEditorContext = useMemo(function () { return ({
    ...
    return (React.createElement(HexEditorContext.Provider, { value: hexEditorContext },
        React.createElement("div", { className: joinClassNames(className, (_b = {},
            ...
            React.createElement("input", { onBlur: handleBlur, onFocus: handleFocus, onKeyDown: handleKeyDown, onPaste: handlePaste, ref: inputRef, style: inputStyle || undefined, tabIndex: tabIndex, type: "text" }),
            !showColumnLabels ? null : (React.createElement("div", { className: classNames.header, style: headerStyle },
                React.createElement(HexEditorRow$1, { className: classNames.rowHeader, classNames: classNames, columns: columns, cursorColumn: cursorColumn, data: columnData, disabled: true, formatOffset: formatHeaderOffset, formatValue: formatHeaderValue, isHeader: true, labelOffset: data.length, nonce: nonce, showAscii: showAscii, showLabel: showRowLabels, style: inlineStyles.row, styles: inlineStyles }))),
            React.createElement(HexEditorBody$1, { className: classNames.body, height: showColumnLabels ? height - rowHeight : height, onItemsRendered: handleItemsRendered, overscanCount: overscanCount || rows, rowCount: rowCount, rowHeight: rowHeight, rows: rows, ref: rowListRef, style: bodyStyle, width: width }, children))));
};
HexEditor.displayName = 'HexEditor';
var HexEditor$1 = memo(forwardRef(HexEditor));
...
var HexEditorMeasureRow = function (_a) {
    ...
    var measureContainerRef = useRef(null);
    var measureGutterRef = useRef(null);
    var measureLabelRef = useRef(null);
    var measureByteRef = useRef(null);
    var measureAsciiRef = useRef(null);
    useLayoutEffect(function () {
    ...
    return (React.createElement("div", { className: className, style: style || undefined, ref: measureContainerRef },
        React.createElement(HexEditorGutter$1, { className: classNames.gutter, ref: measureGutterRef, style: __assign({ width: explicitGutterWidth, height: explicitRowHeight }, styles.gutter) }),
        React.createElement(HexOffsetLabel$1, { className: classNames.offsetLabel, formatOffset: formatOffset, ref: measureLabelRef, offset: offset, style: __assign({ width: explicitLabelWidth, height: explicitRowHeight }, styles.offsetLabel) }),
        React.createElement(HexByteValue, { className: classNames.byte, classNames: classNames, ref: measureByteRef, style: __assign({ width: explicitByteWidth, height: explicitRowHeight }, styles.byte), value: value }),
        React.createElement(HexAsciiValue, { className: classNames.ascii, classNames: classNames, formatValue: formatValue, placeholder: asciiPlaceholder, ref: measureAsciiRef, style: __assign({ width: explicitAsciiWidth, height: explicitRowHeight }, styles.ascii), value: asciiValue == null ? value : asciiValue })));
};
...
var AutoSizeHexEditor = function (_a, ref) {
    ...
    var handleMeasure = useCallback(function (_a) {
    ...
    var measureStyles = useMemo(function () { return ({
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(HexEditorMeasureRow, { asciiPlaceholder: asciiPlaceholder, asciiValue: 0x41, asciiWidth: explicitAsciiWidth, byteWidth: explicitByteWidth, className: props.className, classNames: classNames, formatOffset: formatOffset, formatValue: props.formatValue, gutterWidth: explicitGutterWidth, labelWidth: explicitLabelWidth, offset: props.data.length, onMeasure: handleMeasure, style: measureStyle, styles: measureStyles, value: 0x00 }),
        React.createElement(AutoSizer, { disableWidth: explicitWidth != null || explicitColumns != null, disableHeight: explicitHeight != null || explicitRows != null }, function (_a) {
            ...
            return (React.createElement(HexEditor$1, __assign({ asciiPlaceholder: asciiPlaceholder, classNames: classNames, columns: columns, height: height, inlineStyles: inlineStyles, ref: ref, rowHeight: rowHeight, rows: rows, width: width }, props, { style: __assign(__assign({}, props.style), { width: width,
                    height: height }) })));
        })));
};
AutoSizeHexEditor.displayName = 'AutoSizeHexEditor';
var AutoSizeHexEditor$1 = memo(forwardRef(AutoSizeHexEditor));
...
var StyledHexEditor = function (_a, ref) {
    ...
    return (React.createElement(HexEditor$1, __assign({ inlineStyles: inlineStyles, ref: ref }, restProps)));
};
StyledHexEditor.displayName = 'StyledHexEditor';
var StyledHexEditor$1 = styled(forwardRef(StyledHexEditor))(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["", ""], ["", ""])), hexEditorStyles);
var templateObject_1$1;

var StyledAutoSizeHexEditor = function (_a, ref) {
    var _b = _a.inlineStyles, inlineStyles = _b === void 0 ? EMPTY_INLINE_STYLES : _b, restProps = __rest(_a, ["inlineStyles"]);
    return (React.createElement(AutoSizeHexEditor$1, __assign({ inlineStyles: inlineStyles, ref: ref }, restProps)));
};
StyledAutoSizeHexEditor.displayName = 'StyledAutoSizeHexEditor';
var StyledAutoSizeHexEditor$1 = styled(forwardRef(StyledAutoSizeHexEditor))(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["", ""], ["", ""])), hexEditorStyles);
var templateObject_1$2;

export default StyledAutoSizeHexEditor$1;
export { StyledHexEditor$1 as BaseHexEditor, HexEditor$1 as UnstyledBaseHexEditor, AutoSizeHexEditor$1 as UnstyledHexEditor };

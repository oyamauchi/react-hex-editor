...
import { EDIT_MODE_ASCII, EDIT_MODE_HEX, SELECTION_DIRECTION_BACKWARD, SELECTION_DIRECTION_FORWARD, SELECTION_DIRECTION_NONE } from './constants';
export declare type EditModeType = (typeof EDIT_MODE_ASCII | typeof EDIT_MODE_HEX);
export declare type SelectionDirectionType = (typeof SELECTION_DIRECTION_FORWARD | typeof SELECTION_DIRECTION_BACKWARD | typeof SELECTION_DIRECTION_NONE);
export declare type SetSelectionBoundaryCallback = (offset: number, editMode?: EditModeType, e?: React.MouseEvent) => void;
export declare type SetSelectionRangeCallback = (start: number | null, end?: number | null, direction?: SelectionDirectionType | null, takeFocus?: boolean) => void;
export declare type ValueFormatter = (value: number) => string | JSX.Element | null;
export declare type HexEditorBodyChildren = JSX.Element | null | (() => JSX.Element);
